...
public class weka_predictions {
	...
	public static void main(String[] args) throws Exception {
		...
		String rootPath="C:/Users/akhil/Documents/WEKA/model2/AFTER_DVIDING_SMALL_FILES_AND_LARGE_FILES/"; 
		Classifier cls = (Classifier) weka.core.SerializationHelper.read(rootPath+"randomforest4_use_best.model");
		...
		//below arff file name is created after the first phase of the project and it is agian passed to the second model which will predict if a image is ... 
		PrintWriter writer = new PrintWriter("C:/Users/akhil/Documents/WEKA/model2/AFTER_DVIDING_SMALL_FILES_AND_LARGE_FILES/mode2trainfilelarger_2.arff", "UTF-8");
		...
		Classifier cls2 = (Classifier) weka.core.SerializationHelper.read(rootPath+"classviaregrelarger_best.model");
		//bleow filename is the 
		DataSource source2 = new DataSource("C:/Users/akhil/Documents/WEKA/model2/AFTER_DVIDING_SMALL_FILES_AND_LARGE_FILES/mode2trainfilelarger_2.arff");
								//predict instance class values
		...
		for(int s1=0;s1<originalTrain2.numInstances();s1++){
									...
									String original_full_files = "C:/Users/akhil/Documents/MATLAB/Allfiles/Original_Files/";
									original_full_files = original_full_files + folder_name[0]+".pdf.tiff.png";
									
									File original_files_folder = new File(original_full_files);
										
									if(prediction2.equals("printed")){
										
										//seperating original files
										//below path is for storing the smaller(68-1 type files) printed orginal files 
										String destination_original_files = "C:/Users/akhil/Documents/MATLAB/Allfiles/larger_output_original_files/printed/";
										
										   File destinationFile = new File(destination_original_files, folder_name[0]+".pdf.tiff.png");
										   //recursive copy
										...
										//seperating original files
										//below path is for storing the smaller(68-1 type files) handwritten orginal files
										String destination_original_files = "C:/Users/akhil/Documents/MATLAB/Allfiles/larger_output_original_files/handwritten/";
