// arg1= input path i.e path where arff files are stored. example: C:/Users/akhil/Documents/MATLAB/November/Aiken_ARFF/
...
public class LargeImageClassification {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length != 5){
			System.out.println(
					"Input is of the form: \n<command> <arg0: .arff containing folder filepath> <arg1: .arff filename for second model>"
					+ "<arg2: input path of original files> <arg3: filepath of separated files> <arg4: folder where model is present>"
					);
			return;
		}
		
		String rootPath=args[4]; 
		...
		Classifier cls2 = (Classifier) weka.core.SerializationHelper.read(rootPath+"Step2.large.classViaRegression.model");
