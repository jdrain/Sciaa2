...
function []=LineExtraction(arg1)
    ...
    for iterate=3:length(subfolder_names)
        ...
        srcFiles = dir('C:\Users\akhil\Documents\MATLAB\Allfiles\Original_Files\*.png');  % the folder in which ur images exists

        for ff = 1 : length(srcFiles)
                c=1;
                filename = strcat('C:\Users\akhil\Documents\MATLAB\Allfiles\Original_Files\',srcFiles(ff).name);
                ...
                mkdir('C:\Users\akhil\Documents\MATLAB\Allfiles\Individual_Files\',folder_name{1});
                ...
                bottomLines1 = find(diff(rowsWithText1) == -1);
                    ...
                    for k = 1 : length(topLines1)  % _loop for segmenting horizontal lines_
                        ...
                        bottomRow1 = bottomLines1(k);
                                ...
                                name=strcat('C:\Users\akhil\Documents\MATLAB\Allfiles\Individual_Files\',folder_name{1});
